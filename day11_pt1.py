...
class DumboOctopus:
    def __init__(self, raw_data, steps):
    ...
    def search_for_flash(self, flashes):
        while True:
    ...
    def simulate_steps(self):
        ...
        for _ in range(1, self.steps+1):
            ...
            flashes = self.search_for_flash(flashes)

        return flashes

octopus_flash = DumboOctopus(raw_data, steps)

octopus_flash.simulate_steps()
